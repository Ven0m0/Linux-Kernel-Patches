...
if __name__ == "__main__":
    ...
    if test_data:
        ...
        plot_horizontal_bar_chart_with_annotations(average_times, 'All', sorted_kernel_versions)

        # Plot performance comparison between different kernel versions
        plot_kernel_version_comparison(average_times, 'All', sorted_kernel_versions)
